...
@GetMapping()
    public ResponseEntity<ApiResponse> getAllOrders() {
        ...
        return ResponseEntity.ok(ApiResponse.success("Lista cu toate comenziile", orderDataList));
    ...
    public ResponseEntity<ApiResponse> getOrderById(@PathVariable(name ="id") Long id) {
        ...
        optionalOrderData.orElseThrow(() -> new ResourceNotFoundException("Comanda cu id-ul" + id + "nu a fost gasit"));

        return ResponseEntity.ok(ApiResponse.success("Comanda a fost gasita cu id-ul" + id, optionalOrderData.get()));
    }
    ...
    public ResponseEntity<ApiResponse> createOrder(@RequestBody OrderData orderData) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Comanda a fost salvat cu success", savedOrder));
    }
    ...
    public ResponseEntity<ApiResponse> updateOrder(@RequestBody OrderData orderData) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Comanda a fost actualizata cu success", updatedOrder));
    }
    ...
    public ResponseEntity<ApiResponse> deleteOrderById(@PathVariable(name = "id") Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Comanda a fost stearsa cu success", null));
    }
